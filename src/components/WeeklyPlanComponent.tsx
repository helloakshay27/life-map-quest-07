    ...
    const fetchCalendars = async () => {
      ...
      try {
        ...
        const res = await fetch(
          "https://life-api.lockated.com/user_calendars",
          {
            headers: {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="relative group">
              ...
              <span className="absolute left-0 top-full mt-2 bg-gray-900 text-white text-xs font-medium rounded-lg px-3 py-2 w-[480px] text-center leading-relaxed opacity-0 group-hover:opacity-100 -translate-y-1 group-hover:translate-y-0 pointer-events-none transition-all duration-200 ease-out z-50 shadow-lg whitespace-normal">
              ...
              <div key={dayObj.id} className="flex flex-col gap-2">
                <div className="flex items-center justify-center gap-3">
                  ...
                  <input
                    ...
                    value={dayObj.theme}
                    onChange={(e) =>
                      handleThemeChange(dayObj.id, e.target.value)
                    }
                ...
                <div className="flex justify-center">
                  {!hasPriorities ? (
                    <div
                      className={`w-full border-2 border-dashed rounded-xl py-4 text-center text-[13px] font-medium ${themeColor.dashed} ${themeColor.text} ${themeColor.bg} bg-opacity-40`}
                    >
